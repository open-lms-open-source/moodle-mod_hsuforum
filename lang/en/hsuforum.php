...
$string['tools'] = 'Tools';
$string['replybuttontitle'] = 'Reply to {$a->firstname} {$a->lastname}';
$string['postbyxinreplytox'] = 'Post by {$a->author} {$a->parent}';
$string['postbyxinprivatereplytox'] = 'Post by {$a->author} private reply {$a->parent}';
