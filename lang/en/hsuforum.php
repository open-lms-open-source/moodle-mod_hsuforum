...
$string['flaglabel:bookmark'] = 'Bookmark {$a}.';
$string['flaglabel:substantive'] = 'Mark {$a} as substantive.';
$string['removeflaglabel:bookmark'] = 'Remove bookmark for {$a}.';
$string['removeflaglabel:substantive'] = 'Remove mark {$a} as substantive.';
$string['flagstateon:bookmark'] = '{$a} is bookmarked.';
$string['flagstateon:substantive'] = '{$a} has been marked as substantive.';
$string['flagstateoff:bookmark'] = '{$a} is not bookmarked.';
$string['flagstateoff:substantive'] = '{$a} has not been marked as substantive.';
...
$string['changediscussionsubscription'] = 'Change discussion subscription status';
