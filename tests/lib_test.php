...
class mod_hsuforum_lib_testcase extends advanced_testcase {
    ...
    public function test_hsuforum_trigger_content_uploaded_event() {
        ...
        $cm = get_coursemodule_from_instance('hsuforum', $forum->cmid);
    ...
    /**
     * Test the logic in the hsuforum_tp_can_track_forums() function.
     */
    public function test_hsuforum_tp_can_track_forums() {
        global $CFG;
        ...
        $forumoff = $this->getDataGenerator()->create_module('hsuforum', $options);
        ...
        $forumoptional = $this->getDataGenerator()->create_module('hsuforum', $options);

        // Allow force.
        $CFG->hsuforum_allowforcedreadtracking = 1;

        // User on, forum off, should be off.
        $result = hsuforum_tp_can_track_forums($forumoff, $useron);
        $this->assertEquals(false, $result);

        // User on, forum on, should be on.
        $result = hsuforum_tp_can_track_forums($forumforce, $useron);
        $this->assertEquals(true, $result);

        // User on, forum optional, should be on.
        $result = hsuforum_tp_can_track_forums($forumoptional, $useron);
        $this->assertEquals(true, $result);

        // User off, forum off, should be off.
        $result = hsuforum_tp_can_track_forums($forumoff, $useroff);
        $this->assertEquals(false, $result);

        // User off, forum force, should be on.
        $result = hsuforum_tp_can_track_forums($forumforce, $useroff);
        $this->assertEquals(true, $result);

        // User off, hsuforum optional, should be off.
        $result = hsuforum_tp_can_track_forums($forumoptional, $useroff);
        $this->assertEquals(false, $result);

        // Don't allow force.
        $CFG->hsuforum_allowforcedreadtracking = 0;
    ...
    /**
     * Test the logic in the test_hsuforum_tp_is_tracked() function.
     */
    public function test_hsuforum_tp_is_tracked() {
        global $CFG;
        ...
        // User on, forum off, should be off.
        $result = hsuforum_tp_is_tracked($forumoff, $useron);
        $this->assertEquals(false, $result);

        // User on, forum force, should be on.
        $result = hsuforum_tp_is_tracked($forumforce, $useron);
        $this->assertEquals(true, $result);

        // User on, forum optional, should be on.
        $result = hsuforum_tp_is_tracked($forumoptional, $useron);
        $this->assertEquals(true, $result);

        // User off, forum off, should be off.
        $result = hsuforum_tp_is_tracked($forumoff, $useroff);
        $this->assertEquals(false, $result);

        // User off, forum force, should be on.
        $result = hsuforum_tp_is_tracked($forumforce, $useroff);
        $this->assertEquals(true, $result);

        // User off, forum optional, should be off.
        $result = hsuforum_tp_is_tracked($forumoptional, $useroff);
        $this->assertEquals(false, $result);
        ...
        hsuforum_tp_stop_tracking($forumforce->id, $useron->id);
        hsuforum_tp_stop_tracking($forumoptional->id, $useron->id);
        hsuforum_tp_stop_tracking($forumforce->id, $useroff->id);
        hsuforum_tp_stop_tracking($forumoptional->id, $useroff->id);
    ...
    public function test_hsuforum_tp_get_course_unread_posts() {
        ...
        $discussionoff = $this->getDataGenerator()->get_plugin_generator('mod_hsuforum')->create_discussion($record);
        ...
        $discussionoptional = $this->getDataGenerator()->get_plugin_generator('mod_hsuforum')->create_discussion($record);

        // Allow force.
        $CFG->hsuforum_allowforcedreadtracking = 1;

        $result = hsuforum_tp_get_course_unread_posts($useron->id, $course->id);
        ...
        $result = hsuforum_tp_get_course_unread_posts($useroff->id, $course->id);
    ...
    /**
     * Test the logic in the test_hsuforum_tp_get_untracked_forums() function.
     */
    public function test_hsuforum_tp_get_untracked_forums() {
        global $CFG;
        ...
        $result = hsuforum_tp_get_untracked_forums($useron->id, $course->id);
        $this->assertEquals(1, count($result));
        $this->assertEquals(true, isset($result[$forumoff->id]));

        // Off user with force on.
        $result = hsuforum_tp_get_untracked_forums($useroff->id, $course->id);
        $this->assertEquals(2, count($result));
        $this->assertEquals(true, isset($result[$forumoff->id]));
        $this->assertEquals(true, isset($result[$forumoptional->id]));
