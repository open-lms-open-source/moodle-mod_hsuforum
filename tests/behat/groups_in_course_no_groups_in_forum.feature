@mod @mod_hsuforum
Feature: Advanced forums in 'No groups' mode allow posting to All participants for all users
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | hsuforum   | Standard forum name    | Standard forum description    | C1     | nogroups     | 0         |
  ...
  Scenario: Teacher can post via ajax
    ...
    And I create the following inline discussions:
      | subject            | message            |
      | Teacher 1 -> Forum | Teacher 1 -> Forum |
    And I should see "Teacher 1 -> Forum"
  ...
  Scenario: Student can post via ajax
    ...
    And I create the following inline discussions:
      | subject            | message            |
      | Student 1 -> Forum | Student 1 -> Forum |
    And I should see "Student 1 -> Forum"
