...
Feature: Students can choose from 4 discussion display options and their choice is remembered
  ...
  Background:
    ...
    And I reply "Discussion 1" post from "Test forum name" advanced forum with:
    ...
    And I reply "Discussion 2" post from "Test forum name" advanced forum with:
  ...
  Scenario: Display replies flat, with oldest first
    Given I reply "Discussion 1" post from "Test forum name" advanced forum with:
    ...
    And the field "Display discussion replies" matches value "Display replies flat, with oldest first"
  ...
  Scenario: Display replies flat, with newest first
    ...
    And I reply "Discussion 2" post from "Test forum name" advanced forum with:
      | Subject | Reply 2 to discussion 2 |
      | Message | Discussion contents 2, third message |
    And the field "Display discussion replies" matches value "Display replies flat, with newest first"
    And I should see "Discussion contents 2, first message" in the "div.firstpost.starter" "css_element"
  ...
  Scenario: Display replies in threaded form
    ...
    And the field "Display discussion replies" matches value "Display replies in threaded form"
  ...
  Scenario: Display replies in nested form
    ...
    And I follow "Test forum name"
    And I follow "Discussion 2"
    And the field "Display discussion replies" matches value "Display replies in nested form"
    And I should see "Discussion contents 2, first message" in the "div.firstpost.starter" "css_element"
