...
@mod @mod_hsuforum
Feature: When creating a new discussion the unpin option should exist as a button

  @javascript
  Scenario: The pin button should exist
    ...
    Then "button.pinbutton.btn.btn-default" "css_element" should exist
