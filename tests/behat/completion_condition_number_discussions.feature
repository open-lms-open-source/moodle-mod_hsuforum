@mod @mod_hsuforum
Feature: Set a certain number of discussions as a completion condition for an advanced forum
  ...
  Scenario: Set X number of discussions as a condition
    ...
    And I follow "Course 1"
    Then the "Test forum name" "hsuforum" activity with "auto" completion should be marked as complete
    And I log out
    And I log in as "teacher1"
    And I follow "Course 1"
