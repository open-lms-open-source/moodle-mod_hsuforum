...
/**
 * Tests for mod_hsuforum_backup_hsuforum_activity_task.
 *
...
require_once($CFG->dirroot . '/mod/hsuforum/backup/moodle2/backup_hsuforum_activity_task.class.php');
    ...
    public function encode_content_links_provider() {
        ...
        return [
            'Link to the list of forums for current wwwroot' => [
                sprintf('%s/mod/hsuforum/index.php?id=42', $CFG->wwwroot),
                '$@HSUFORUMINDEX*42@$',
            ],
            'Link to forum view by moduleid for current wwwroot' => [
                sprintf('%s/mod/hsuforum/view.php?id=29', $CFG->wwwroot),
                '$@HSUFORUMVIEWBYID*29@$',
            ],
            'Link to forum view by forumid for current wwwroot' => [
                sprintf('%s/mod/hsuforum/view.php?f=31', $CFG->wwwroot),
                '$@HSUFORUMVIEWBYF*31@$',
            ],
            'Link to forum discussion with parent syntax for current wwwroot' => [
                sprintf('%s/mod/hsuforum/discuss.php?d=26&parent=99', $CFG->wwwroot),
                '$@HSUFORUMDISCUSSIONVIEWPARENT*26*99@$',
            ],
            ...
            'Link to forum discussion with relative syntax for current wwwroot' => [
                sprintf('%s/mod/hsuforum/discuss.php?d=1040#9930', $CFG->wwwroot),
                '$@HSUFORUMDISCUSSIONVIEWINSIDE*1040*9930@$',
            ],
            'Link to forum discussion by discussionid for current wwwroot' => [
                sprintf('%s/mod/hsuforum/discuss.php?d=9304', $CFG->wwwroot),
                '$@HSUFORUMDISCUSSIONVIEW*9304@$',
            ],
            'Link to the list of forums for other wwwroot' => [
                sprintf('%s/mod/hsuforum/index.php?id=42', $altwwwroot),
                sprintf('%s/mod/hsuforum/index.php?id=42', $altwwwroot),
            ],
            'Link to forum view by moduleid for other wwwroot' => [
                sprintf('%s/mod/hsuforum/view.php?id=29', $altwwwroot),
                sprintf('%s/mod/hsuforum/view.php?id=29', $altwwwroot),
            ],
            'Link to forum view by forumid for other wwwroot' => [
                sprintf('%s/mod/hsuforum/view.php?f=31', $altwwwroot),
                sprintf('%s/mod/hsuforum/view.php?f=31', $altwwwroot),
            ],
            'Link to forum discussion with parent syntax for other wwwroot' => [
                sprintf('%s/mod/hsuforum/discuss.php?d=26&parent=99', $altwwwroot),
                sprintf('%s/mod/hsuforum/discuss.php?d=26&parent=99', $altwwwroot),
            ],
            ...
            'Link to forum discussion with relative syntax for other wwwroot' => [
                sprintf('%s/mod/hsuforum/discuss.php?d=1040#9930', $altwwwroot),
                sprintf('%s/mod/hsuforum/discuss.php?d=1040#9930', $altwwwroot),
            ],
            'Link to forum discussion by discussionid for other wwwroot' => [
                sprintf('%s/mod/hsuforum/discuss.php?d=9304', $altwwwroot),
                sprintf('%s/mod/hsuforum/discuss.php?d=9304', $altwwwroot),
            ],
        ];
    }
