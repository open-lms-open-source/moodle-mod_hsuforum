...
class mod_hsuforum_maildigest_testcase extends advanced_testcase {
    ...
    public function test_mod_hsuforum_set_maildigest() {
        global $USER, $DB;
        ...
        $this->assertEquals(count($forumids),
            $DB->count_records_select('hsuforum', 'id ' . $test, $params));
    ...
    public function test_mod_hsuforum_get_user_digest_options_default() {
        global $USER, $DB;
    ...
    public function test_mod_hsuforum_get_user_digest_options_sorting() {
        global $USER, $DB;
