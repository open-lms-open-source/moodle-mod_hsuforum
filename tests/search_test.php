...
require_once($CFG->dirroot . '/mod/hsuforum/tests/generator/lib.php');
...
class mod_hsuforum_search_testcase extends advanced_testcase {
    ...
    public function setUp() {
        ...
        $this->forumpostareaid = \core_search\manager::generate_areaid('mod_hsuforum', 'post');
    ...
    public function test_posts_indexing() {
        ...
        $forum2 = self::getDataGenerator()->create_module('hsuforum', ['course' => $course1->id]);
        $record = new stdClass();
        $record->course = $course1->id;
        $record->userid = $user1->id;
    ...
    public function test_posts_document() {
        ...
        $post1 = $DB->get_record('hsuforum_posts', array('id' => $discussion1reply1->id));
    ...
    public function test_posts_group_support() {
        ...
        $forum = self::getDataGenerator()->create_module('hsuforum', ['course' => $course->id,
    ...
    public function test_attach_files() {
        ...
        $post = $DB->get_record('hsuforum_posts', array('discussion' => $discussion1->id));
        $filerecord = array(
    ...
    public function test_posts_get_contexts_to_reindex() {
        ...
        $forum1 = $generator->create_module('hsuforum', ['course' => $course1->id]);
        $forum2 = $generator->create_module('hsuforum', ['course' => $course1->id]);
        $forum3 = $generator->create_module('hsuforum', ['course' => $course2->id]);
        $forum4 = $generator->create_module('hsuforum', ['course' => $course2->id]);
