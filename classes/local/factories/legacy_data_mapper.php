...
use mod_hsuforum\local\data_mappers\legacy\author as author_data_mapper;
use mod_hsuforum\local\data_mappers\legacy\discussion as discussion_data_mapper;
use mod_hsuforum\local\data_mappers\legacy\forum as forum_data_mapper;
use mod_hsuforum\local\data_mappers\legacy\post as post_data_mapper;
use mod_hsuforum\local\entities\forum;
...
class legacy_data_mapper {
    /**
     * Create a legacy hsuforum data mapper.
     *
