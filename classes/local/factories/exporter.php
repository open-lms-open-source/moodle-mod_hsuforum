...
use mod_hsuforum\local\entities\post_read_receipt_collection as post_read_receipt_collection_entity;
use mod_hsuforum\local\factories\author_entity;
use mod_hsuforum\local\factories\discussion_summary_entity;
...
use mod_hsuforum\local\exporters\forum as forum_exporter;
use mod_hsuforum\local\exporters\discussion as discussion_exporter;
use mod_hsuforum\local\exporters\discussion_summaries as discussion_summaries_exporter;
use mod_hsuforum\local\exporters\post as post_exporter;
use mod_hsuforum\local\exporters\posts as posts_exporter;
use context;
use rating;
use stdClass;
