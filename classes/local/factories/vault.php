...
use mod_hsuforum\local\factories\legacy_data_mapper;
use mod_hsuforum\local\vaults\author as author_vault;
use mod_hsuforum\local\vaults\discussion as discussion_vault;
use mod_hsuforum\local\vaults\discussion_list as discussion_list_vault;
use mod_hsuforum\local\vaults\forum as forum_vault;
use mod_hsuforum\local\vaults\post as post_vault;
use mod_hsuforum\local\vaults\post_attachment as post_attachment_vault;
use mod_hsuforum\local\vaults\post_read_receipt_collection as post_read_receipt_collection_vault;
use file_storage;
use moodle_database;
