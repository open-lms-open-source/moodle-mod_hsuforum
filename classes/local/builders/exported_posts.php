...
namespace mod_hsuforum\local\builders;
 ...
 * for taking a set of related hsuforums, discussions, and posts and generate the exported
...
class exported_posts {
    ...
    private function get_tags_from_posts(array $posts): array {
        ...
        return core_tag_tag::get_items_tags('mod_hsuforum', 'hsuforum_posts', $postids);
    }
