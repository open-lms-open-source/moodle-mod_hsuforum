...
namespace mod_hsuforum\local\entities;
...
class forum {
    ...
    public function is_subscription_optional(): bool {
        return $this->get_subscription_mode() === HSUFORUM_CHOOSESUBSCRIBE;
    }
    ...
    public function is_subscription_forced(): bool {
        return $this->get_subscription_mode() === HSUFORUM_FORCESUBSCRIBE;
    }
    ...
    public function is_subscription_automatic(): bool {
        return $this->get_subscription_mode() === HSUFORUM_INITIALSUBSCRIBE;
    }
    ...
    public function is_subscription_disabled(): bool {
        return $this->get_subscription_mode() === HSUFORUM_DISALLOWSUBSCRIBE;
    }
    ...
    /**
     * Does the hsuforum have blocking enabled?
     *
     * @return bool
     */
    ...
    /**
     * Is the cutoff date for the hsuforum reached?
     *
     * @return bool
     */
