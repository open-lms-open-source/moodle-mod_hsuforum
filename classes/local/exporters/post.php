...
use mod_hsuforum\local\exporters\author as author_exporter;
...
class post extends exporter {
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        if ($loadcontent) {
            ...
            $subject = $isdeleted ? get_string('forumsubjectdeleted', 'hsuforum') : get_string('forumsubjecthidden', 'hsuforum');
            $message = $isdeleted ? get_string('forumbodydeleted', 'hsuforum') : get_string('forumbodyhidden', 'hsuforum');
            $timecreated = null;
        }
    ...
    protected static function define_related() {
        return [
            ...
            'author' => 'mod_hsuforum\local\entities\author',
            'authorcontextid' => 'int?',
            'user' => 'stdClass',
            'context' => 'context',
    ...
    private function get_author_subheading_html(stdClass $exportedauthor, int $timecreated): string {
        ...
        return get_string('bynameondate', 'mod_hsuforum', ['name' => $name, 'date' => $date]);
    }
