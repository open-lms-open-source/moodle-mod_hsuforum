...
/**
 * The mod_hsuforum discussion_subscription created event.
 *
...
/**
 * The mod_hsuforum discussion_subscription created event class.
 *
...
class discussion_subscription_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' subscribed the user with id '$this->relateduserid' to the discussion " .
            " with id '{$this->other['discussion']}' in the advanced forum with the course module id '$this->contextinstanceid'.";
    }
