...
class hsuforum_post implements \renderable, \templatable {
     ...
     *
     * @param \mod_hsuforum_renderer $renderer The render to be used for formatting the message and attachments
     ...
     * @return array Data ready for use in a mustache template
     */
    protected function export_for_template_text(\mod_hsuforum_renderer $renderer) {
        return array(
     ...
     * @return array Data ready for use in a mustache template
     */
    protected function export_for_template_html(\mod_hsuforum_renderer $renderer) {
        return array(
            'id'                            => $this->post->id,
    ...
    public function get_postdate() {
        ...
        if (!empty($config->enabletimedposts) && ($this->discussion->timestart > $postmodified)) {
